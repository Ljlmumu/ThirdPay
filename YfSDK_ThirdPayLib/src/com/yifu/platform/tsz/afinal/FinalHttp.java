 ...
 */
package com.yifu.platform.tsz.afinal;
...
import com.yifu.platform.tsz.afinal.http.AjaxCallBack;
import com.yifu.platform.tsz.afinal.http.AjaxParams;
import com.yifu.platform.tsz.afinal.http.HttpHandler;
import com.yifu.platform.tsz.afinal.http.RetryHandler;
import com.yifu.platform.tsz.afinal.http.SyncRequestHandler;
...
public class FinalHttp {
    ...
    private static int httpThreadCount = 1;//http线程池数量
