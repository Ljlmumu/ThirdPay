...
public class WeiXinPayModel {
	...
	public WeiXinPayModel(String _agent_id, Order order, String _agent_bill_time, String _notify_url,
			String _return_url, String _user_ip,String _pay_type) {
		super();
		this._version = "1";
		this._is_phone = "1";
		this._is_frame = "0";
		...
		this._agent_bill_id = order.order_id;
		this._agent_bill_time = _agent_bill_time;
		this._pay_amt = new BigDecimal(order.price).divide(new BigDecimal(100)).toString();
		this._notify_url = _notify_url;
		this._return_url = _return_url;
		this._user_ip = _user_ip;
		this._goods_name = order.desc;
		this._goods_num = "1";
		this._goods_note =  order.desc;
		this._remark = order.mchNo;
	}
